...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    # ),
    # "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT45BG45-if00-port0": DynamixelRobotConfig(
    #     joint_ids=(1, 2, 3, 4, 5, 6, 7),
    #     joint_offsets=(
    #         2 * np.pi / 2,
    #         2 * np.pi / 2,
    ...
    # left Panda
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT3FSJGP-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6, 7),
        joint_offsets=(
            4 * np.pi / 2,
            2 * np.pi / 2,
